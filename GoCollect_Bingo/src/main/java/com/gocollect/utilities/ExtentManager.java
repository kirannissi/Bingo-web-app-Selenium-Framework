package com.gocollect.utilities;
...
public class ExtentManager {
	...
	public static ExtentReports createInstance(String timeStamp) {
		...
		htmlReporter.config().setDocumentTitle("Bingo Test Automation Project");
		htmlReporter.config().setEncoding("utf-8");
		htmlReporter.config().setReportName("Bingo Test Automation Report");
